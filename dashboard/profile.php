  ...
  <div class="row">
    ...
    padding: 42px 0;">
                  ...
                  <div class="card-body text-center"  >
                    ...
                    <img id="p_img" src="<?php echo $_SESSION['user_Img'];?>" alt="Profile Image"  runat="server"  height="125" width="125" class="rounded-circle" style="border:1px solid; border-color:#383d41;"/>
                    </div>
                    ...
                    <table class="table table-striped">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td colspan="3"><?php echo $_SESSION['user_Name'];?></td>
                        </tr>
                        <tr>
                          <th scope="row">Email:</th>
                          <td id="profile_email"><?php echo $_SESSION['user_Email'];?></td>
                          <td></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <img id="u_img" src="../assets/img/uploads/blank.png" alt="Change Profile Image"  runat="server"  height="125" width="125" class="rounded-circle" style="border:1px solid; border-color: #ad1455;"/>
        <br>  <br>
